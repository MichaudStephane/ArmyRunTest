...
namespace AtelierXNA
{
    ...
    public class SectionVentilateurDroite : SectionDeNiveau
    {
        ...
        protected override void CréerSection()
        {
            ...
            Ventilateur1 = new Ventilateur(Jeu, HOMOTHÉTIE_INITIALE_TERRAIN/100, Vector3.Zero, new Vector3(PositionInitiale.X + HitBoxBase.X, PositionInitiale.Y + 4, PositionInitiale.Z - HitBoxBase.Z), INTERVAL_MAJ, "stefpath", min, max,"Droite");
